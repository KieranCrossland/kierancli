...
## Rust mode.
This mode allows execution of kierancli's built in functions such as pwd, ls, help, etc. (these are hard-coded into the binary and editing these requires a recompilation.)
